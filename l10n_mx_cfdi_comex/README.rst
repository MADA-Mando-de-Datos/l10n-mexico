...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fl10n--mexico-lightgray.png?logo=github
    :target: https://github.com/OCA/l10n-mexico/tree/18.0/l10n_mx_cfdi_comex
    :alt: OCA/l10n-mexico
...
`feedback <https://github.com/OCA/l10n-mexico/issues/new?body=module:%20l10n_mx_cfdi_comex%0Aversion:%2018.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/l10n-mexico <https://github.com/OCA/l10n-mexico/tree/18.0/l10n_mx_cfdi_comex>`_ project on GitHub.
